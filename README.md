...
In more detail, the DOM captures data that has been extracted or utilised sucessfully (or unsuccessfully) by a Task together with any events captured in the process. They can be visualised as follows:
